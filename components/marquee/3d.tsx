...
export function Marquee3D() {
  return (
    <div className="relative flex max-w-[400px] h-full w-full flex-col items-center justify-center gap-4 overflow-hidden rounded-lg border bg-background px-20 md:shadow-xl">
